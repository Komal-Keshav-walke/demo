...
<i class="lni lni-protection"></i>
  ...
  <script>
   ...
   <div class="row table-responsive">
                      ...
                      <h3 style="text-align:center; color:#631266" >Welcome To Pathology Department.</h3>
                      </div>
      ...
      <div class="row mb-3" >
        ...
        <a href="pathologytotalpatients.php" style="text-decoration:none">
                            <div class="card text-center mb-3" style="width: 18rem;">
                      <div class="card-body">
                        <h5 class="card-title" style="color:black">Total Patients Records</h5>
                        <p class="card-text"style="color:black"> Patients Count:</p>
                        <a href="pathologytotalpatients.php" class="btn btn-primary" style="background-color:purple;outline:none;border:none">List</a>
                      </div>
                    </div>
          </a>
        </div>
        <!-- Column 2 -->
        <div class="col-md-6 col-lg-4 col-xl-3">
        <a href="pathologyipdlist.php" style="text-decoration:none">
                        <div class="card text-center mb-3" style="width: 18rem;">
                  <div class="card-body">
                    <h5 class="card-title" style="color:black">IPD Patients Records</h5>
                    <p class="card-text"style="color:black"> Patients Count:</p>
                    <a href="pathologyipdlist.php" class="btn btn-primary" style="background-color:purple;outline:none;border:none">List</a>
                  </div>
                </div>
          </a>
        </div>
        <!-- Column 3 -->
        <div class="col-md-6 col-lg-4 col-xl-3">
             <a href="pathologyopdlist.php" style="text-decoration:none">
                            <div class="card text-center mb-3" style="width: 18rem;">
                  <div class="card-body">
                    <h5 class="card-title" style="color:black">OPD Patients Records</h5>
                    <p class="card-text"style="color:black"> Patients Count:</p>
                    <a href="pathologyopdlist.php" class="btn btn-primary" style="background-color:purple;outline:none;border:none">List</a>
                  </div>
                </div>
          </a>
        </div>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
             <a href="pathologyemergencylist.php" style="text-decoration:none">
                            <div class="card text-center mb-3" style="width: 18rem;">
                  <div class="card-body">
                    <h5 class="card-title" style="color:black">Emergrncy Records</h5>
                    <p class="card-text"style="color:black"> Patients Count:</p>
                    <a href="pathologyemergencylist.php" class="btn btn-primary" style="background-color:purple;outline:none;border:none">List</a>
                  </div>
                </div>
          </a>
        </div>
