...
<input type="hidden" id="id" name="id" value="<?php echo $id?>">
      ...
      <input type="text" class="form-control" name="dname" id="dname" placeholder="Enter your Doctor name"> -->
      <label for="dname">Doctor Name</label>
          <select class="form-control" id="dname"  name="dname" >

                <option name="dname" value="Shubham Shinde" <?php if($row['Doctor_name']== 'Shubham Shinde'){ echo 'selected';}?>>Shubham Shinde</option>

                <option name="dname" value="Pranav Jhadav"<?php if($row['Doctor_name']== 'Pranav Jhadav'){ echo 'selected';}?>>Pranav Jhadav</option>

                <option name="dname" value="Komal"<?php if($row['Doctor_name']== 'Komal'){ echo 'selected';}?>>Komal</option>
       </select>
         
      </div>
      <div class="col-md-4 mb-3">
      <label for="aadhar">Aadhar No.</label>
      <input type="text" class="form-control" name="aadhar" id="aadhar" placeholder="1234-4567-7891"value="<?php echo $row['Aadharno'];?>">
      </div>
      </div>
      ...
      <div class="col-md-12">
          ...
          <input type="text" class="form-control mb-3" name="description" id="description" style="height: 60px;" value="<?php echo $row['Description'];?>">
      </div>
      <hr style="color:purple;">

      </div>
      <div style="text-align:center">
                                            <button type="submit" name="update"  id="update" class="btn btn-primary button">Submit</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
