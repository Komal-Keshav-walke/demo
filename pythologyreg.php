...
if(isset($_POST['submit'])){
  ...
  $test=$_POST['test'];
  $lang = "";
  $doctor_referal=$_POST['doctor_referal'];
...
for($i = 0; $i<$lglen; $i++){
  ...
  $myfile = $_FILES["myfile"]["name"];
                ...
                $folder = "upload/" .$myfile;

                $sqla = "SELECT * FROM pathologyreg where aadharno= '$aadharno'";
           ...
           $sql="INSERT INTO `pathologyreg`(`name`,`aadharno`,`email`,`contact`,`dateofbirth`,`disease`,`treatment`,`address`,`test`,`doctor_referal`,`myfile`) VALUES('$name','$aadharno','$email','$contact','$dateofbirth','$disease','$treatment','$address','$lang','$doctor_referal','$myfile')";
...
?>
    ...
    <div class="container">
      <form method="post" action="#" enctype="multipart/form-data" style="padding-top:20px">
        <div class="card p-4">
          ...
          <div class="row">
            <div class="form-group col-sm-6">
              ...
              <select name="doctor_referal"class="form-select" >
              <option name="doctor_referal" value="dr1">Select Doctor</option>
                <option name="doctor_referal" value="Dr.Komal">Dr.komal</option>
                <option name="doctor_referal" value="Dr.Shubham">Dr.shubham</option>
                <option name="doctor_referal" value="Dr.Sonal">Dr.sonal</option>
                <option name="doctor_referal" value="Dr.Shubhamc">Dr.shubhamc</option>
                <option name="doctor_referal" value="Dr.Mrug">Dr.mrug</option>
          ...
          <br>
                ...
                <h5><label for="blood test">Test:</label></h5>
                  ...
                  <div class="row">
                    <div class="form-group col-sm-3 ">
                      <input type="checkbox" class="form-check-input" id="test" name="test[]" value="CBC">
                      <label for="test"> CBC</label><br>
                    </div>
                    <div class="form-group col-sm-3">
                      <input type="checkbox" class="form-check-input" id="test"  name="test[]" value="Uric acid">
                      <label for="test"> Uric acid</label><br>
                    </div>
                    <div class="form-group col-sm-3">
                      <input type="checkbox" class="form-check-input" id="test"  name="test[]" value="Aso test">
                      <label for="test"> Aso test</label><br>
                    </div>
                    <div class="form-group col-sm-3">
                      <input type="checkbox" class="form-check-input" id="test"  name="test[]" value="Lft">
                      <label for="test"> Lft</label><br>
                      </div>
</div>
                  
                      <div class="row">
                      <div class="form-group col-sm-3">
                      <input type="checkbox" class="form-check-input" id="test"  name="test[]" value="Rft">
                      <label for="test">Rft</label><br>
                      </div>
                      <div class="form-group col-sm-3">
                      <input type="checkbox" class="form-check-input" id="test"  name="test[]" value="sugar">
                      <label for="test"> sugar</label><br>
                    </div>
                    <div class="form-group col-sm-3">
                      <input type="checkbox" class="form-check-input" id="test"  name="test[]" value="Calcium">
                      <label for="test">Calcium</label><br>
                      </div>
                      <div class="form-group col-sm-3">
                        <input type="checkbox" class="form-check-input" id="test"  name="test[]" value="pp sugar">
                        <label for="test">Pp sugar</label><br>
                        </div>
                      </div>

                      <div class="row">
                        <div class="form-group col-sm-3">
                        <input type="checkbox" class="form-check-input" id="test"  name="test[]" value="Lipid profile">
                        <label for="test">Lipid profile</label><br>
                        </div>
                        <div class="form-group col-sm-3">
                        <input type="checkbox" class="form-check-input" id="test"  name="test[]" value="RA test">
                        <label for="test">RA test</label><br>
                      </div>
                      <div class="form-group col-sm-3">
                        <input type="checkbox" class="form-check-input" id="test" name="test[]" value="Stool routine">
                        <label for="test">Stool routine</label><br>
                        </div>
            ...
            <div class="row justify-content-center" style="text-align: center">
              <div class="form-group col-sm-2 ">
                <button type="submit" name="submit" id="submit" class="btn btn-primary"style="background-color:purple;border:none">Submit</button>
