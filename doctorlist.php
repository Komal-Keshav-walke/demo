  ...
  <div class="main-content" style="padding: 0;">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary" id="navbar">
      ...
      " alt="Bootstrap" width="55" height="54" style="border-radius: 50%; margin: 4px; float: right;">
        ...
        <a href="AdminDashboard.php" style="padding:1px"><i class="fa fa-home"></i> Home</a>
                        ...
                        <table class="table table-bordered" id="mytable">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><a href="dpatient.php?id=<?php echo $row['id']; ?>"><i class="fa-regular fa-eye"></i></a></td>
                                    <td style="text-align:center;"><a href="profile.php?id=<?php echo $row['id']; ?>" style="text-align: center;">View</a></td>
