...
<i class="lni lni-protection"></i>
  ...
  <div class="main-content" style="padding: 0;">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary" id="navbar">
      ...
      <!-- <h2 style="text-align: center;font-family: Arial, Helvetica, sans-serif;"><i class="fa-solid fa-hospital-user"></i>&nbsp;Update Department</h2>
      <hr>
            ...
            <div class="container">
      <form method="post" action="updatedepartment.php" enctype="multipart/form-data" style="padding-top:30px">
        <div class="card p-4">
        <h2 style="text-align: center;font-family: Arial, Helvetica, sans-serif;"><i class="fa-solid fa-hospital-user"></i>&nbsp;Update Department</h2>
          <br />
          ...
          <div class="row">
            ...
            <div class="form-group col-sm-6">
              ...
              <input type="file" name="newfile" class="form-control" value="<?php echo $row['myfile']; ?>">
            <input type="hidden" name="oldfile" value="<?php echo $row['myfile']; ?>">
            </div>
            ...
            <div class="row justify-content-center" style="text-align: center">
              <div class="form-group col-sm-2 ">
                <button type="submit" name="update" id="update" class="btn btn-primary"style="background-color:purple;border:none">Submit</button>
