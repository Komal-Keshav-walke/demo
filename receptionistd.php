...
$query="SELECT COUNT(*) AS totalappiontment FROM appointment";
...
$countappointment= $row['totalappiontment'];
...
<div class="container" style="margin-top: 50px;">
  <div class="row">
      ...
      <div class="col-sm-3 " id="cont">
          <div class="card mb-3" style="max-width: 540px;">
              <div class="row g-0">
                <div class="col-md-4">
                  
                  <img src="https://img.freepik.com/free-vector/nurse-helping-patient-concept-illustration_114360-22273.jpg?w=740" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    <h5 class="card-title" style="color: purple;">Total Patients</h5>
                    <h4><?php echo $countpatatient ?></h4>
          ...
          <div class="card mb-3" style="max-width: 540px;">
              <div class="row g-0">
                <div class="col-md-4">
                  ...
                  <img src="https://img.freepik.com/free-vector/hand-drawn-hospital-reception-scene_23-2148837408.jpg?w=740" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    <h5 class="card-title" style="color: purple;">Appointments</h5>
                    <h4><?php echo $countappointment ?></h4>
      ...
      <div class="col-sm-3" id="cont">
          <div class="card mb-3" style="max-width: 540px;">
              <div class="row g-0">
                <div class="col-md-4">
                  <img src="https://img.freepik.com/premium-vector/doctors-examine-the-lying-patient_951778-33982.jpg?w=740" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    <h5 class="card-title" style="color: purple;">Admit Patients</h5>
                    <h4><?php ?></h4>
      ...
      <div class="col-sm-3" id="cont">
          <div class="card mb-3" style="max-width: 540px;">
              <div class="row g-0">
                <div class="col-md-4">
                <img src="https://img.freepik.com/premium-vector/happy-world-blood-donor-day-red-white-background-social-media-design-banner-free-vector_1340-21588.jpg?w=740" height="90px" class="img-fluid rounded-start" alt="...">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                  <h5 class="card-title" style="color: purple;">Blood Bank</h5>
                    <h4><?php echo $countblood ?> Litre</h4>
