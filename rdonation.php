...
if($query){
  ...
  $(document).ready(function(){
      Swal.fire({
          title: "Register!",
          text: "Donar Registered successfully!",
          icon: "success",
            ...
            <div class="col-md-12">
              <div class="card ">
                ...
                <div class="header p-3" style="height:50px;">
                  ...
                  <h3 class="card-title"><i class="fa-solid fa-hand-holding-droplet"
                      style="color:red;"></i>&nbsp;&nbsp;Blood Donation</h3>
                </div>
                <hr>
                <div class="card-body bg-light">
                  ...
                  <form method="post" action="#" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-4">
                        <label for="blood" class="form-label">Bloodgroups:<span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                      <div class="form-group col-md-4">
                        <label for="donate" class="form-label">Donar Donated
                          Blood(ml)<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="donate" required />
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-4">
                        <label for="date">Date of Blood Donate</label>
                        <input type="date" name="date" class="form-control" required />
                      </div>

                      <div class="form-group col-md-4">
                        <label for="dona">Have you donated previously?<span class="text-danger">*</span></label>
                        <div class="section1">
                          <input type="radio"class="form-check-input" value="Yes" name="dona" id="input" required />
                          <label for="id1">Yes</label>

                          <input type="radio" class="form-check-input" value="No" name="dona" id="input" />
                      ...
                      <div style="text-align:center">
                        ...
                        <button type="reset" name="reset" id="newbtn"
                          class="btn btn-dark button">Reset</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
