...
$sql= "SELECT * FROM patients WHERE patient='IPD'";
...
<div class="container">
                    ...
                    <div class="col-sm-8">
                      <h2 style="text-align:center;">Total IPD Patients List</h2>
                      </div>
                      <div class="col-sm-4">
                        ...
                        <table class="table table-bordered" id="mytable">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><a href="demos.php?id=<?php echo $row['id']; ?>">View</a></td>
                                    <td style="text-align:center;"><a href="editpatient.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil" style="font-size:20px; color:black;"></i></a>&nbsp;&nbsp;&nbsp;
                                    <a hhref="#" onclick="showDeleteConfirmation(event, <?php echo $row['id']; ?>)"><i class="fa fa-trash" style="font-size:20px; color:red;"></i></a></td>
                                </tr>
                            </tbody>
                            <?php } ?>
