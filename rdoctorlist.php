...
<div class="container">
              <div class="row table-responsive">
                      <h2><i class="fa-solid fa-user-doctor mt-3" style="color:purple"></i>&nbsp;&nbsp;Doctor List -</h2>
                      <hr>
                        <table class="table table-bordered" id="mytable">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><a href="rdpatient.php?id=<?php echo $row['id']; ?>"><i class="fa-regular fa-eye"></i></a></td>
