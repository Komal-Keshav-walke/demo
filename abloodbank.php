    ...
    <div class="container p-2">
                  ...
                  <div class="row">
                              ...
                              <div class="col-sm-2" id="appoint">
                                  ...
                                  <h6>Available - <?php echo $Opositive  ?>&nbsp;litre</h6>

                              </div>
                              <div class="col-sm-2" id="appoint">
                                  <h2><i class="fa-solid fa-droplet" style="color:#c60000;"></i>&nbsp;&nbsp;AB+</h2>
                                  <h6>Available - <?php echo $ABpositive  ?>&nbsp;litre</h6>
                      ...
                      <div class="row">
                          <div class="col-sm-2" id="appoint">
                                <h2><i class="fa-solid fa-droplet" style="color:#c60000;"></i>&nbsp;&nbsp;A-</h2>
                                <h6>Available - <?php echo $Anegative  ?>&nbsp;litre</h6>
                          </div>
                          <div class="col-sm-2" id="appoint">
                                <h2><i class="fa-solid fa-droplet" style="color:#c60000;"></i>&nbsp;&nbsp;B-</h2>
                                <h6>Available - <?php echo $Bnegative  ?>&nbsp;litre</h6>
                          ...
                          <div class="col-sm-2" id="appoint">
                                <h2><i class="fa-solid fa-droplet" style="color:#c60000;"></i>&nbsp;&nbsp;O-</h2>
                                <h6>Available - <?php echo $Onegative  ?>&nbsp;litre</h6>

                          </div>
                          <div class="col-sm-2" id="appoint">
                                <h2><i class="fa-solid fa-droplet" style="color:#c60000;"></i>&nbsp;&nbsp;AB-</h2>
                                <h6>Available - <?php echo $ABnegative  ?>&nbsp;litre</h6>
