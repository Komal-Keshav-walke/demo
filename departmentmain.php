...
?>
   ...
   <div class="row table-responsive">
                      ...
                      <h3 style="text-align:center; color:#631266" >Welcome To &nbsp;<?php echo $name ?> Department.</h3>
                      </div>
      ...
      <div class="row mb-3" >
        ...
        <a href="departmenttotalpatients.php" style="text-decoration:none">
                      ...
                      <div class="card-body">
                        ...
                        <a href="departmenttotalpatients.php" class="btn btn-primary" style="background-color:purple;outline:none;border:none">List</a>
                      </div>
                    </div>
          </a>
        </div>
        ...
        <a href="#" style="text-decoration:none">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text"style="color:black"> Patients Count:</p>
                    <a href="departmentipdlist.php" class="btn btn-primary" style="background-color:purple;outline:none;border:none">List</a>
                  </div>
                </div>
          </a>
        </div>
        <!-- Column 3 -->
        <div class="col-md-6 col-lg-4 col-xl-3">
             <a href="icuopdlist.php" style="text-decoration:none">
                            <div class="card text-center mb-3" style="width: 18rem;">
                  <div class="card-body">
                    <h5 class="card-title" style="color:black">OPD Patients Records</h5>
                    <p class="card-text"style="color:black"> Patients Count:</p>
                    <a href="departmentopdlist.php" class="btn btn-primary" style="background-color:purple;outline:none;border:none">List</a>
                  </div>
                </div>
          </a>
        </div>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
             <a href="icuemergencylist.php" style="text-decoration:none">
                            <div class="card text-center mb-3" style="width: 18rem;">
                  <div class="card-body">
                    <h5 class="card-title" style="color:black">Emergrncy Records</h5>
                    <p class="card-text"style="color:black"> Patients Count:</p>
                    <a href="departmentemergencylist.php" class="btn btn-primary" style="background-color:purple;outline:none;border:none">List</a>
                  </div>
                </div>
          </a>
        </div>
