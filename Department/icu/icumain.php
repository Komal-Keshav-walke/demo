...
<i class="lni lni-protection"></i>
  ...
  <div class="main-content" style="padding: 0;">
   ...
   <div class="row table-responsive">
                      ...
                      <h3 style="text-align:center; color:#631266" >Welcome To ICU Department.</h3>
                      </div>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
             <a href="icuopdlist.php" style="text-decoration:none">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text"style="color:black"> Patients Count:</p>
                    <a href="icuopdlist.php" class="btn btn-primary" style="background-color:purple;outline:none;border:none">List</a>
                  </div>
                </div>
          </a>
        </div>
