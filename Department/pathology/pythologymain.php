      ...
      <div class="row mb-3" >
        ...
        <a href="AdminDashboard.php" style="text-decoration:none">
                      ...
                      <div class="card-body">
                        ...
                        <a href="#" class="btn btn-primary" style="background-color:purple;outline:none;border:none">List</a>
                      </div>
                    </div>
          </a>
        </div>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
             <a href="AdminDashboard.php" style="text-decoration:none">
                            <div class="card text-center mb-3" style="width: 18rem;">
                  <div class="card-body">
                    <h5 class="card-title" style="color:black">New Patients Register</h5>
                    <p class="card-text"style="color:black"> Patients Count:</p>
                    <a href="pythologyreg.php" class="btn btn-primary" style="background-color:purple;outline:none;border:none">Register</a>
                  </div>
                </div>
          </a>
        </div>
