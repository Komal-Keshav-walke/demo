...
<div class="container">
    <div class="row ">
        <div class="col-md-12">
            ...
            <button onclick="preventsubmit(event);toggleDiv('hiddenDivv');" class="btn btn-primary "> Add Prescription</button>
...
<script>
        ...
        <table class="table table-bordered" id="dynamicTable">
            <thead>
                <tr>
                    ...
                    <th>Morning-tab(after)</th>
                    <th>Afternoon-tab(after)</th>
                    <th>Evening-tab(after)</th>
                    <th>Lunch/Dinner</th>
                    <th>blood Test</th>
                    <th>Medical Test</th>
    ...
    <select class="form-control" id="morning" name="tab_morning[]">
        <option value="" disabled selected hidden>Tablet Qty</option>
    ...
    <select class="form-control" id="evening" name="tab_evening[]">
        ...
        <option value="three" >3 tablets</option>
                    ...
                    <td>  <select class="form-control" id="lunch"  name="tab_lunch[]" >
                               ...
                               <option value="" disabled selected hidden>Lunch</option>
                                ...
                                <td>  <select class="form-control" id="test"  name="test[]" >
                               
                               <option value="" disabled selected hidden>Test details</option>
                                 <option value ="CBC">blood</option>
                                 <option value = "lft">xyz</option>
                                
                    

                                 <!-- CBC , lft ,rft, calcium, phosphorus, fasting sugar and pp sugar, lipid profile, uric acid, RA test , aso test , urine routine, stool routine,
                           -->
                                </select></td>
        ...
        <button onclick="addRow();" class="btn btn-primary mt-2" name="add">Add Row</button>
              ...
              <div class="form-group form-check">
                            ...
                            <div style="text-align:center">
                                <button type="submit" name="update"  id="newbtn" class="btn btn-primary button">Submit</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        function addRow() {
            ...
            <td>${tableBody.children.length + 1}</td>
                    ...
                    <td>  <select class="form-control" id="lunch"  name="tab_lunch[]" >
                               ...
                               <option value="" disabled selected hidden>Tablet Time</option>
                               ...
                               <option value="" disabled selected hidden>Blood Test</option>
