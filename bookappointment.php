...
$sql="INSERT INTO `appointment`(`Name`, `Doctor_name`, `Aadharno`, `Contact`, `Email`, `Date`,`Time`, `Address`, `Gender`, `Description`) VALUES ('$name','$dname','$aadhar','$contact','$email','$date','$time','$address','$gender','$description')";
...
if($query){
  ...
  $(document).ready(function(){
      Swal.fire({
          ...
          // window.location.href = "doctorlist.php"; // Redirect to view2.php after user clicks OK
          window.history.go(-2);
      });
  });
</script>';
...
<div class="container pt-4">
                <div class="row ">
                    <div class="col-md-12">
                        ...
                        <!-- <div class="header p-1" style="background-color:purple;color:white;height:50px;"> -->
                        <div class="header p-3" style="height:50px;">

                            
                                <h3 class="card-title"><i class="fa-solid fa-calendar-plus" style="color:purple;"></i>&nbsp;&nbsp;Book Appointment</h3>
                            ...
                            <div class="card-body bg-light">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Enter your name" oninput="this.value=this.value.replace(/[^a-zA-Z ]/g,'')" required>
                                    </div>
                                       
            
                                        <div class="form-group col-md-4">
                                        <label for="dname">Doctor Name<span class="text-danger">*</span></label>
                                    ...
                                    <input type="text" class="form-control" name="aadhar" id="aadhar" placeholder="1234-4567-7891" oninput="this.value=this.value.replace(/[^0-9]/g,'')"    size="12" minlength="12" maxlength="12" required >
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                        <label for="contact">Conatct<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="contact" id="contact" placeholder="Enter your number" oninput="this.value=this.value.replace(/[^0-9]/g,'')"    size="10" minlength="10" maxlength="10" required>
                                        </div>
                              ...
                              <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <input type="text" class="form-control mb-3" name="description" id="description" style="height: 60px;">
                                        </div>
            
            
            
                                        <div style="text-align:center">
                                            <button type="submit" name="submit"  id="reset" class="btn btn-primary button">Submit</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <button type="reset" name="reset"  id="reset" class="btn btn-dark button">Reset</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                       
                                       
                                        <!-- <button  class="btn btn-basic button" id="btn">
