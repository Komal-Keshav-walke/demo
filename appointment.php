...
$query1="SELECT COUNT(*) AS daytotal FROM appointment Where DATE(date) = CURDATE()";
$dayres= mysqli_query($conn, $query1);
$dayrow= mysqli_fetch_assoc($dayres);
$daycount= $dayrow['daytotal'];

//upcoming-up appointment count

$query2="SELECT COUNT(*) AS uptotal FROM appointment Where DATE(date) > CURDATE()";
$upres= mysqli_query($conn, $query2);
$uprow= mysqli_fetch_assoc($upres);
$upcount= $uprow['uptotal'];

////Cancel appointment count
$query3="SELECT COUNT(*) AS canceltotal FROM appointment Where `Status`='Cancel'";
$cancelres= mysqli_query($conn, $query3);
$cancelrow= mysqli_fetch_assoc($cancelres);
$cancelcount= $cancelrow['canceltotal'];
                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="date" id="appointmentDate" value="<?php echo $date ?>" class="form-control" name="date" onchange="filterAppointments()">
                        ...
                        <div class="table-responsive mt-2" style="height:50vh;">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><a href="editappointment.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil" style="font-size:20px; color:black;"></i></a>&nbsp;&nbsp;&nbsp;
