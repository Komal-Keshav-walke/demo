...
if(isset($_POST['submit'])){
 ...
 $password=$_POST['password'];
  ...
  $myfile = $_FILES["myfile"]["name"];
                ...
                $folder = "upload/departmentlogo/" .$myfile;

                
               
           $sql = "INSERT INTO `department` (`name`, `username`, `password`, `myfile`) VALUES ('$name', '$username', '$password', '$myfile')";
...
?>
    ...
    <div class="container">
      <form method="post" action="#" enctype="multipart/form-data" style="padding-top:30px">
        <div class="card p-4">
          <h2 style="text-align: center">New Department Registrations</h2>
          <br />
          <div class="row">
          ...
          <div class="row">
            <div class="form-group col-sm-6">
              ...
              <input type="password" class="form-control" placeholder="Enter Strong Password" id="password" name="password"/>
            </div>
