                        ...
                        <table class="table table-bordered" id="mytable">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><a href="editnurse.php?id=<?php echo $row['id']; ?>" ><i class="fa fa-pencil" style="font-size:20px; color:black;"></i></a>&nbsp;&nbsp;&nbsp;
    ...
    function showDeleteConfirmation(event, id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "deletenurse.php?id=" + id;
            }  else {
