...
if ($aadhar) {
    ...
    $sql = "SELECT pr.tablet_name, pr.tablet_quantity, pr.tab_morning, pr.tab_afternoon, pr.tab_evening, pr.tab_lunch, pr.test, pr.medical, pr.created_at, pat.fname, pat.age, pat.gender, pat.doctor
    FROM prescription AS pr
    JOIN patients AS pat ON pr.aadhar = pat.aadhar
    WHERE pr.aadhar = '$aadhar' AND DATE(pr.created_at) = DATE(NOW())";
...
<div class="container mt-4">
  <div id="print">
    ...
    <hr><br><br>
        ...
        <div class="">
    <h5><u>Prescription By :-</u><b>Dr.  <?= htmlspecialchars($patient_info['doctor']) ?></b></h5><br>
    <h6>Signature  :-____________________</h6>
    </div>
