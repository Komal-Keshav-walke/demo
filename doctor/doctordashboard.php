...
$sql = "SELECT * FROM patients WHERE `doctor`='$dname'";
$res = mysqli_query($conn, $sql);
$total_records = mysqli_num_rows($res);


$sql = "SELECT * FROM appointment WHERE `Doctor_name`='$dname'";
$res = mysqli_query($conn, $sql);
$total_record = mysqli_num_rows($res);

//appointment for upcomming
$sql2 = "SELECT * FROM appointment WHERE `Doctor_name`='$dname' AND DATE(Date) > CURDATE()";
$res2 = mysqli_query($conn, $sql2);
$total_record1 = mysqli_num_rows($res2);

 $sql3 = "SELECT * FROM appointment WHERE `Doctor_name`='$dname' AND DATE(Date) = CURDATE()";

 
$res3 = mysqli_query($conn, $sql3);
$total_record3 = mysqli_num_rows($res3);
...
<i class="lni lni-protection"></i>
  ...
  <div class="row">
    <div class="col-md-3 animate__animated animate__fadeInDown">
      ...
      <div class="card scale cardsize">
        <div class="card-body rounded" >
          <div class="row align-items-center">
            <!-- <div class="col-md-6">
              <img src="https://www.svgrepo.com/download/284184/doctor.svg"  alt="Doctor Icon" style="height:90px;">
            </div> -->
            <div class="col-md-12 animated-text">
              <h4 class="card-title" style="color:purple;text-align:center">Hello...<br> Dr.<?php echo $row1['Name'] ?>!!</h4>
    ...
    <div class="col-md-3  animate__animated animate__fadeInDown">
      <div class="card scale cardsize">
        <div class="card-body  rounded">
          <div class="row align-items-center">
            <div class="col-md-4">
            <a href="imppatientlist.php" style="color: purple;">
            <i class="fa-solid fa-bed" style="font-size:50px;"></i>
            </a>
            </div>
            <div class="col-md-8 ">
              <h5 class="card-title" style="color:purple">Total Patients List</h5>
    ...
    <div class="col-md-3 animate__animated animate__fadeInDown">
      <div class="card scale cardsize">
        <div class="card-body  rounded">
          <div class="row align-items-center">
            <div class="col-md-4">
            <a href="doctorappointmentlist.php" >
            <i class="fas fa-calendar-alt" style="font-size:50px "></i> 
               </a>
            </div>
            <div class="col-md-8">
              <h5 class="card-title" style="color:purple ">Todays Appointments</h5>
              <h4 class="card-text" style="text-align:center">
              
                  <?php echo $total_record3; ?>
    ...
    <div class="col-md-3 animate__animated animate__fadeInDown">
      <div class="card scale cardsize">
        <div class="card-body rounded">
          <div class="row align-items-center">
            <div class="col-md-4">
            <a href="upcommingapp.php" style="color: black;">
            <i class="fas fa-calendar-alt"style="font-size:50px"></i>
            </a>
            </div>
            <div class="col-md-8">
              <h5 class="card-title " style="color:purple;">Upcoming Appointments</h5>
              <h4 class="card-text" style="text-align:center">
              
                   <?php echo $total_record1; ?>
