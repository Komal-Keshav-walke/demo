...
if(isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM `appointment` WHERE `Doctor_name`='$dname' AND `Date` BETWEEN '$fdate' AND '$tdate' ";

    $res = mysqli_query($conn, $sql);

     $sql="SELECT * FROM `appointment` WHERE DATE(Date)=CURDATE() AND `Doctor_name`='$dname'";

} else {
    $sql = "SELECT * FROM appointment WHERE `Doctor_name`='$dname' AND DATE(Date) > CURDATE()";
    $res = mysqli_query($conn, $sql);
