...
$sql1 = "SELECT * FROM `patients` WHERE `doctor`='$dname'";
$res1 = mysqli_query($conn, $sql1);
// print_r(empty($res)).die;



// SQL query to fetch hospital records
                ...
                while($row= mysqli_fetch_array($res1)){ ?>
                    <tr>
                        ...
                        <td style="text-align:center">
                            <a href="pprofile.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm"><i class="fa-solid fa-address-card"></i></a>
                </td>

                            <td style="text-align:center">
                            <a href="editpatient.php?id=<?php echo $row['id'];?>" class="btn btn-success btn-sm"><i class="fa-solid fa-pills"style="font-size:20px;" ></i></i></a>
                </td>
                            <td style="text-align:center">
                        ...
                        <td style="text-align:center">
                            ...
                            <a href="viewprescription.php?aadhar=<?php echo $row['aadhar']; ?>" class="btn btn-success btn-sm">View</a>
                        </td>
                        
                        <td style="text-align:center">
                            

                            <a href="prescription_history.php?aadhar=<?php echo $row['aadhar']; ?>" class="btn btn-primary btn-sm"><i class="fa-solid fa-clock-rotate-left"></i></a>
                        </td>
                        ...
                        <td>
                                    ...
                                    <td><div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item " href="confirmpatient.php?id=<?php echo $row['id']; ?>&status=<?php echo "Confirm"; ?>">Confirm</a></li>
                                            <li><a class="dropdown-item" href="confirmpatient.php?id=<?php echo $row['id']; ?>&status=<?php echo "Cancel"; ?>">Cancel</a></li>
                                        </ul>
                                        </div>
                                </td>
                    </tr>
