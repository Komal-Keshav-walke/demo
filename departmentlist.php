...
<body>
  ...
  <div class="main-content" style="padding: 0;">
    ...
    <div class="row breadcrumb-div" >
                                <div class="col-md-6">
                                    <ul class="breadcrumb" >
            							             <li><a href="AdminDashboard.php" style="text-decoration:none;color:black"><i class="fa fa-home"></i> Home &nbsp;/</a></li>
                                        <li> Doctor &nbsp;/</li>
    ...
    <div class="container" style="margin-top: 20px;">
                    <div class="row table-responsive">
                      ...
                      <div class="col-sm-3">
                       ...
                       <div class="col-sm-1">
                        <a href="departmentreg.php" class="btn"title="Add Department"><i class="fa-regular fa-square-plus" style="color:purple;font-size:25px"></i></a>
                       </div>
                        ...
                        <table class="table table-bordered" id="mytable" style="text-align:center">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><img src="upload/departmentlogo/<?php echo $row['myfile']; ?>" style="width:100px;height:100px;"></td>
                                   
                                    
                                    
                                    <td style="text-align:center;"><a href="editdepartment.php?id=<?php echo $row['id']; ?>" ><i class="fa fa-pencil" style="font-size:20px; color:black;"></i></a>&nbsp;&nbsp;&nbsp;
