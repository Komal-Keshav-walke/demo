...
// $dname= $_SESSION['fname'];
$id = $_GET['id'];
// $sql = "SELECT * FROM `patients` WHERE `patient` = 'IPD' AND `id` ='$id'";
    $sql1 = "SELECT * FROM `patients` WHERE `patient` = 'IPD' AND `id` ='$id'";
    $res1 = mysqli_query($conn,$sql1);
  
            $show = mysqli_fetch_assoc($res1);
      // $sql = "SELECT * FROM patients";
      // $result = $conn->query($sql);
      $sql2 = "SELECT * FROM `patients` WHERE `patient` = 'IPD' AND `id` ='$id'";
...
<i class="lni lni-protection"></i>
  ...
  <div class="main-content" style="padding: 0;">
    ...
    Name of Patients:<?php echo $show['fname']; ?>
        ...
        <table class="table table-bordered table-hover mt-4" id="mytable">
            ...
            <tbody>
                ...
                while($row= mysqli_fetch_array($res2)){ ?>
                    <tr>
                        <td><?php echo $cn++; ?></td>
                        <!-- <td><img src="upload/reports/<?php echo $row['report']; ?>" style="width:100px;height:100px;"></td> -->
                      <td>    <input type="button" value="view report" onClick="ln();" />
</td>

                        <td>
                            <a href="pprofile.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">View</a>
...
<div class="container-fluid" >
    <!-- <div class="div1"> -->
      ...
      $sql="SELECT report from patients where id='$id'";
...
function ln(){
document.getElementById('looknorth').innerHTML='<embed type="application/pdf" src="upload/reports/<?php echo $info['report'] ; ?>" width="100%" height="750">';
  }
</script>
    ...
    <!-- <div>
      <input type="button" class="btn btn-primary" name="sub" id="sub" value="print">
    </div> -->
    </div>
